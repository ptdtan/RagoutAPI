...
class RagoutInstance(object):
    ...
    """
    def __init__(self, maf, references, ancestor, ancestor_fasta, phyloStr,
                 threads=4,
                 outDir="ragout_out",
                 scale="large",
                 outLog="ragout_log",
        ...
        self._get_phylogeny_and_naming_ref(phyloStr)
        self._make_recipe()
    ...
    def _set_debugging(self):
        self.debug_root = os.path.join(self.outDir, "debug")
    ...
    def _get_phylogeny_and_naming_ref(self, phyloStr):
        ...
        if phyloStr:
            ...
            phylogeny = Phylogeny.from_newick(phyloStr)
        else:
        ...
        self.phylogeny, self.naming_ref = phylogeny, naming_ref
        pass
